...
const Movies = () => {
  ...
  const getMovieCard = movie => {
    return <div key={movie.id}
              className='w-[160px] h-[30vh] bg-center bg-cover m-6 md:h-[50vh] md:w-[180px] relative rounded-xl hover:scale-110 duration-300 flex items-end '
              style={{
            ...
            >
              ...
              <div className='text-white font-bold text-center w-full bg-gray-900 bg-opacity-60 rounded-xl'>
